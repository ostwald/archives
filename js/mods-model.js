    ...
    render_id_links: function () {
        ...
        var techmd_fits_link = (function  () {
            ...
            return $('<div>')
                ...
                .html ($t('a')
                    .html("TECHMD")
                    .attr('href', OPENSKY_BASE_URL + '/fedora/objects/' + pid + '/datastreams/TECHMD_FITS/content')
                    .attr('target', 'techmd')
                    .attr('title', 'See Technical Metadata for this object'))
        })();
